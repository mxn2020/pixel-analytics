...
export default function SettingsPage() {
    ...
    return (<div style={{ padding: "var(--space-6)", maxWidth: 900 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "var(--space-6)" }}>
            <h1 style={{ fontSize: "var(--font-size-2xl)", fontWeight: 700, display: "flex", alignItems: "center", gap: "var(--space-2)" }}><SettingsIcon style={{ color: "var(--color-text-secondary)" }} /> Site Settings</h1>
        ...
        <div className="card" style={{ padding: "var(--space-6)", marginBottom: "var(--space-6)" }}>
            ...
            <div style={{ position: "relative", background: "var(--color-bg-secondary)", padding: "var(--space-4)", borderRadius: "var(--radius-sm)", border: "1px solid var(--color-border)" }}>
                ...
                <button className="btn btn-sm" onClick={copy} style={{ position: "absolute", top: 8, right: 8, background: "var(--color-bg-card)", boxShadow: "var(--card-shadow)" }}>
